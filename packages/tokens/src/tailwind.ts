  ...
  theme: {
    extend: {
      colors: {
        ...
        "canvas-badge-bg": "var(--canvas-badge-bg)",
        "canvas-badge-text": "var(--canvas-badge-text)",
        "canvas-badge-remote": "var(--canvas-badge-remote)",
        "canvas-badge-hybrid": "var(--canvas-badge-hybrid)",
        "canvas-badge-onsite": "var(--canvas-badge-onsite)",
        "canvas-badge-contractor": "var(--canvas-badge-contractor)",
        "canvas-badge-intern": "var(--canvas-badge-intern)",
        "canvas-badge-tenure": "var(--canvas-badge-tenure)",
      },
      borderRadius: {
